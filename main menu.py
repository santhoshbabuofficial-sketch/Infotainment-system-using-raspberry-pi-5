...
class InfotainmentUI(QMainWindow):
    def __init__(self):
        ...
        self.control_panel_path = "D:/infotainment system/control panel.py"  # CHANGE THIS PATH
        self.navigation_path = "D:/infotainment system/navigation menu.py"  # CHANGE THIS PATH
